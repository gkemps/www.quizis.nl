...
$mail->Subject = 'Betalingsverzoek Winterparadijs Pubquiz';
try {
...
FROM
    ...
    where t.quiz_quiz_id in (156,157) and paid IS NULL";

$result = $conn->query($sql);

$i = 0;
while($row = $result->fetch_array(MYSQLI_ASSOC)) {
    $message = file_get_contents("public/templates/email_winterparadijs_payment.html");
