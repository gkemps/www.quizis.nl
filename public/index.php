...
// list all the possible questions
$questions = [
    [
        'quote' => 'Dit is een goed stel hoor!',
        'question' => 'Welke TV-commentator zei dit over het Nederlands elftal na de EK finale \'88?',
        'answers' => ["Herman Kuiphof", "Theo Reitsma", "Evert ten Napel", "Hugo Walker"],
        'correct_answer' => 'Theo Reitsma',
        'picture' => 'goed-stel.jpg'
    ],
    [
        'quote' => 'Even kijken wie er uit gaat .... Arjen Robben??',
        'question' => 'Voor wie werd Arjen Robben tijdens het EK 2004 tegen Tsjechie in de 59e minuut gewisseld?',
        'answers' => ["Andy van der Meijde", "Patrick Kluivert", "Paul Bosvelt", "Clarence Seedorf"],
        'correct_answer' => 'Paul Bosvelt',
        'picture' => 'wissel-robben.jfif'
    ],
    [
        'quote' => 'Hij pakt hem weer! Hij kende hem dus inderdaad',
        'question' => 'Hans van Breukelen stopte in de EK finale een strafschop. Welke sovjet speler miste van elf meter?',
        'answers' => ["Aleksandr Zavarov", "Sjarhej Hotsmanov", "Igor Belanov", "Oleg Protasov"],
        'correct_answer' => 'Igor Belanov',
        'picture' => 'hans-van-breukelen.jfif'
    ],
    [
        'quote' => 'Nee, nee, nee! Hoe is dit mogelijk!',
        'question' => 'Wie miste er 2 strafschoppen tegen Italie in de halve finale van het EK 2000?',
        'answers' => ["Ronald de Boer", "Patrick Kluivert", "Frank de Boer", "Clarence Seedorf"],
        'correct_answer' => 'Frank de Boer',
        'picture' => 'ek-2000-penalty.webp'
    ],
];
...
shuffle($answers);
# rotate questions q steps
$questions = array_merge(array_slice($questions, $q), array_slice($questions, 0, $q));
...
<body id="home" class="homepage">
    ...
    <section id="main-slider">
        <div class="owl-carousel">
            <?php foreach ($questions as $index => $question2): ?>
                <div class="item" style="background-image: url(images/ek2024/<?php echo $question2['picture']; ?>);">
            ...
            <?php endforeach; ?>
            <!--/.item-->
            <div class="item" style="background-image: url(images/ek2024/wissel-robben.jfif);">
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
            ...
            <div class="item" style="background-image: url(images/ek2024/hans-van-breukelen.jfif);">
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
    ...
    <section id="cta" class="wow fadeIn">
        <div class="container">
            <div class="row">
                <div class="col-sm-9">
                    <h2>"<?php echo $question['quote'] ?>"</h2>
                    <p><?php echo $question['question'] ?>
                    </p>
                    <p>
                        <a id="answer-a" class="btn btn-primary btn-lg">A. <?php echo $answers[0]; ?></a>
                        <a id="answer-b" class="btn btn-primary btn-lg">B. <?php echo $answers[1]; ?></a>
                        <a id="answer-c" class="btn btn-primary btn-lg">C. <?php echo $answers[2]; ?></a>
                        <a id="answer-d" class="btn btn-primary btn-lg">D. <?php echo $answers[3]; ?></a>
                    </p>
                    <p><a href="/?q=<?php echo $q + 1; ?>">Andere vraag spelen?</a></p>
                </div>
                <!-- <div class="col-sm-3 text-right">
                    <a class="btn btn-primary btn-lg" href="#features">Meer Quizzen?</a>
                </div> -->
            </div>
        </div>
    </section>
    ...
    <script>
        // above we have 4 buttons, button A B C & D. 
        // button C is the correct answer
        // the other buttons reflect wrong answers
        // create a javascript script that will turn the button green if the correct answer is clicked
        // and red if the wrong answer is clicked
        // the correct answer is C
        // the wrong answers are A, B and D

        // create a function that will change the color of the button
        // the function will take 2 arguments, the button and the color
        ...
        buttonA.addEventListener('click', function () {
            // if the button is clicked, change the color to red
            <?php if ($answers[0] === $question['correct_answer']): ?>
                changeColor(buttonA, 'green');
            <?php else: ?>
                changeColor(buttonA, 'red');
            <?php endif; ?>
        });

        buttonB.addEventListener('click', function () {
            // if the button is clicked, change the color to red
            <?php if ($answers[1] === $question['correct_answer']): ?>
                changeColor(buttonB, 'green');
            <?php else: ?>
                changeColor(buttonB, 'red');
            <?php endif; ?>
        });

        buttonC.addEventListener('click', function () {
            // if the button is clicked, change the color to green
            <?php if ($answers[2] === $question['correct_answer']): ?>
                changeColor(buttonC, 'green');
            <?php else: ?>
                changeColor(buttonC, 'red');
            <?php endif; ?>
        });

        buttonD.addEventListener('click', function () {
            // if the button is clicked, change the color to red
            <?php if ($answers[3] === $question['correct_answer']): ?>
                changeColor(buttonD, 'green');
            <?php else: ?>
                changeColor(buttonD, 'red');
            <?php endif; ?>
        });
    </script>
    ...
    <section id="features">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Meer quizzen?</h2>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="media service-box wow fadeInRight">
                        ...
                        <div class="media-body">
                            ...
                            <p>Iedere maand organiseren we een pubquiz bij Brouwerij Vandeoirsprong. <a
                                    href="https://quizis.nl/meedoen">Schrijf je in</a> voor 26 juni</p>
                        </div>
                    </div>
                    ...
                    <div class="media service-box wow fadeInRight">
                        ...
                        <div class="media-body">
                            ...
                            <p>Quiz voor je bedrijf of familiedag? Vraag een <a href="mailto:info@quizis.nl">offerte</a>
                                aan!</p>
                        </div>
                    </div>
                    ...
                    <div class="media service-box wow fadeInRight">
                        ...
                        <div class="media-body">
                            ...
                            <p>Quiz in een thema naar keuze? Over sport (of het EK!), film of toch het afgelopen
                                jaar.</p>
                        </div>
                    </div>
