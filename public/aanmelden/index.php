...
$sql = "SELECT * FROM quizis.quiz_Quiz where date > '" . date("Y") . "-" . date("m") . "-" . date("d") . " " . date("H", strtotime("-2 hours")) . ":" . date("i") . ":" . date("s") . "' AND date <= '" . date("Y") . "-" . date("m") . "-" . date("d") . " 23:59:59' AND private = 0 and presentation = 1  order by date ASC limit 1";
