        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 text-center">
                    ...
                    <div class="display-4">Teambijdrage van &euro;20 graag voldoen <a href="https://www.bunq.me/quiz/20/<?php echo urlencode($_GET['quizId'] . "-" .$_GET['team'] . "-" . $_GET['captain']); ?>/ideal">via deze link</a>. Na betaling ontvangen jullie binnen 48h een bevestiging van inschrijving.</div>
                    <div class="display-4">Graag tot in het Carnavalstheater!</div>
                </div>
            </div>
        </div>
    </section>
